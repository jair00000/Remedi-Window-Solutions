                 ...
                 <Card className="p-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                     <div className="text-center">
                       ...
                       <p className="text-black dark:text-white text-sm">Invisible protection that maintains natural light and clear views</p>
                     </div>
                     <div className="text-center">
                       ...
                       <p className="text-black dark:text-white text-sm">Subtle tone with effective heat rejection for comfort and efficiency</p>
                     </div>
                     <div className="text-center">
                       ...
                       <p className="text-black dark:text-white text-sm">Enhanced privacy and high-level heat control for modern homes</p>
                     </div>
                   </div>
                ...
                <Card className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    <div className="text-center">
                      ...
                      <p className="text-black dark:text-white text-sm">Complete privacy with light diffusion</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                        Etched
                      </div>
                      <p className="text-black dark:text-white text-sm">Decorative patterns and textures</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                        Mirrored
                      </div>
                      <p className="text-black dark:text-white text-sm">One-way vision with reflective surface</p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-black dark:text-white text-sm">Custom designs and logos</p>
                    </div>
                  </div>
                  <p className="text-gray-600 dark:text-gray-300 text-center">
                 ...
                 <Card className="p-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                     <div className="text-center">
                       ...
                       <p className="text-gray-600 dark:text-gray-300 text-sm">Standard protection for residential windows and low-risk areas</p>
                     </div>
                     <div className="text-center">
                       <div className="bg-green-100 text-green-800 dark:bg-green-500 dark:text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                         7 Mil
                       </div>
                       <p className="text-gray-600 dark:text-gray-300 text-sm">Enhanced safety for homes with increased exposure or higher security needs</p>
                     </div>
                     <div className="text-center">
                       <div className="bg-purple-100 text-purple-800 dark:bg-purple-500 dark:text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                         14 Mil
                       </div>
                       <p className="text-gray-600 dark:text-gray-300 text-sm">Maximum protection for vulnerable windows and severe weather-prone regions</p>
                     </div>
                   </div>
                   <p className="text-gray-600 dark:text-gray-300 text-center">
                 ...
                 <Card className="p-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                     <div className="text-center">
                       ...
                       <p className="text-black dark:text-white text-sm">Modern lines and structural designs</p>
                     </div>
                     <div className="text-center">
                       <div className="bg-green-100 text-green-800 dark:bg-green-500 dark:text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                         Nature
                       </div>
                       <p className="text-black dark:text-white text-sm">Leaf-inspired and organic patterns</p>
                     </div>
                     <div className="text-center">
                       <div className="bg-purple-100 text-purple-800 dark:bg-purple-500 dark:text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                         Abstract
                       </div>
                       <p className="text-black dark:text-white text-sm">Artistic visuals with creative forms</p>
                     </div>
                     <div className="text-center">
                       <div className="bg-gray-800 text-white dark:bg-gray-400 dark:text-white px-4 py-2 rounded-full text-sm font-semibold mb-3 inline-block">
                         Custom
                       </div>
                       <p className="text-black dark:text-white text-sm">Tailored designs made specifically for your home</p>
                     </div>
                   </div>
                   <p className="text-gray-600 dark:text-gray-300 text-center">
