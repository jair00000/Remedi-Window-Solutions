    ...
    <>
      ...
      <div className="relative h-[100vh] sm:h-[70vh] flex items-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('/Remedi-Window-Solutions/images/solutions/About-Hero-logo.webp')`,
          ...
          <div className="container-custom">
            <div className="text-center">
              <div className="flex justify-center mb-8">
                <img 
                  src="/Remedi-Window-Solutions/images/icons&logo/Avery-Dennsion-Logo.webp" 
